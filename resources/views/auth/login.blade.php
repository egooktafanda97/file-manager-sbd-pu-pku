...
<head>
    ...
    <meta content="https://kanakku.dreamstechnologies.com/{{ asset('') }}assets/img/kanakku.jpg"
        name="twitter:image">
    ...
    <div class="main-wrapper login-body">
        <div class="login-wrapper">
            <div class="container">
                ...
                {{-- <img alt="Logo" class="img-fluid logo-dark mb-2 logo-color"
                    src="{{ asset('') }}assets/img/logo2.png">
                <img alt="Logo" class="img-fluid logo-light mb-2"
                    src="{{ asset('') }}assets/img/logo2-white.png"> --}}
                <div class="w-full">
                ...
                <div class="loginbox">
                    <div class="login-right">
                        <div class="login-right-wrap">
                            <h1>Login</h1>
                            <p class="account-subtitle">Access to our file manager</p>
                            @if (session('success'))
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-check custom-checkbox">
                                                <input class="form-check-input" id="cb1" type="checkbox">
    ...
    <div class="offcanvas offcanvas-end border-0 " id="theme-settings-offcanvas" tabindex="-1">
        <div class="sidebar-headerset">
            ...
            <div class="sidebar-headerclose">
                <a aria-label="Close" data-bs-dismiss="offcanvas"><img alt="img"
                        ...
                        <div class="col-4">
                            <div class="form-check card-radio p-0">
                                ...
                                <label class="form-check-label avatar-md w-100" for="customizer-layout01">
                                    <img alt="img" src="{{ asset('') }}assets/img/vertical.png">
                                </label>
                            </div>
                        ...
                        <div class="col-4">
                            <div class="form-check card-radio p-0">
                                ...
                                <label class="form-check-label  avatar-md w-100" for="customizer-layout02">
                                    <img alt="img" src="{{ asset('') }}assets/img/horizontal.png">
                                </label>
                            </div>
                        ...
                        <div class="col-4 d-none">
                            <div class="form-check card-radio p-0">
                                ...
                                <label class="form-check-label  avatar-md w-100" for="customizer-layout03">
                                    <img alt="img" src="{{ asset('') }}assets/img/two-col.png">
                                </label>
                            </div>
                            ...
                            <div class="col-4">
                                <div class="form-check card-radio p-0 ">
                                    ...
                                    <label class="form-check-label avatar-md w-100 px-2" for="layout-width-boxed">
                                        <img alt="img" src="{{ asset('') }}assets/img/boxed.png">
                                    </label>
                                </div>
                        ...
                        <div class="col-4">
                            <div class="form-check card-radio p-0">
                                ...
                                <label class="form-check-label  avatar-md w-100" for="topbar-color-dark">
                                    <img alt="img" src="{{ asset('') }}assets/img/dark.png">
                                </label>
                            </div>
                            ...
                            <div class="col-4 d-none">
                                <div class="form-check sidebar-setting card-radio p-0">
                                    ...
                                    <label class="form-check-label  avatar-md w-100" for="sidebar-size-compact">
                                        <img alt="img" src="{{ asset('') }}assets/img/compact.png">
                                    </label>
                                </div>
                            ...
                            <div class="col-4">
                                <div class="form-check sidebar-setting card-radio p-0 ">
                                    ...
                                    <label class="form-check-label avatar-md w-100" for="sidebar-size-small-hover">
                                        <img alt="img" src="{{ asset('') }}assets/img/small-hover.png">
                                    </label>
                                </div>
                            ...
                            <div class="col-4">
                                <div class="form-check sidebar-setting card-radio p-0">
                                    ...
                                    <label class="form-check-label  avatar-md w-100" for="sidebar-view-detached">
                                        <img alt="img" src="{{ asset('') }}assets/img/detached.png">
                                    </label>
                                </div>
